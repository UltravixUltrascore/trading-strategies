...
def calculate_stop_loss_take_profit(df, atr_multiplier=2):
...
# Applica la funzione per calcolare stop loss e take profit
df = calculate_stop_loss_take_profit(df, atr_multiplier=2)
